...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    if (!isset($_POST['csrf_token']) || !isset($_SESSION['csrf_token']) ||
        ...
        echo "<div style='color: red;'>Security validation failed. Please try again.</div>";
        echo "</div>";
        return;
    }
...
Selecteer type:<BR>
    ...
    <br><br>Handbak of automaat?<BR>
        <input type="radio" name="trans" value="M" checked> Handbak<br>
        <input type="radio" name="trans" value="A"> Automaat
    <br><br>
    <?php else: ?>
    <br><br>Handbak of automaat?<BR>
        <input type="radio" name="trans" value="M"> Handbak<br>
...
?>
<center>
<form name="secure" id="secure" action="index.php?navigate=adminedit2" method="post">
<br>Kenteken:<br>
